...
const SecondaryButton = ({ onPress, text, iconName, }) => {
  return (
    <TouchableOpacity style={styles.button} onPress={onPress}>
      <View style={styles.buttonContent}>
     { iconName?<MaterialCommunityIcons name={iconName} size={20} color="white" />:null}
...
const styles = StyleSheet.create({
  button: {
    backgroundColor: '#6231AD', // Change this to your desired background color
